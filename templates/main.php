...
<?php foreach ($params['items'] ?? [] as $item): ?>
            <div class="col-3 border border-2 rounded-1 border-white me-3 d-flex justify-content-center item">
                <div class="box text-center">
                    ...
                    <?php if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']===true): ?>
                        <a class="btn btn-outline-info mb-2" href="/?action=show&id=<?php echo $item->getId();?>">Uzupełnij</a>
                    <?php endif; ?>
                </div>
            </div>
<?php endforeach ?>
